import {showLoadingButton, hideLoadingButton, displayError, displaySuccess} from "./utils.js";
  ...
  async function sendContact(e) {
    ...
    await Email.send({
      ...
      Body: emailBody,
        ...
        message => message = "OK" ? displaySuccess("Message Recieved, Thank You", formMessage, contactForm, e.submitter, "SUBMIT") : displayError(error, formMessage)
    )        
};